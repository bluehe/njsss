        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview active">
                ...
                <ul class="treeview-menu">
                    ...
                    <li>
                        <a href="<?php echo WEB_ROOT; ?>/work/index#forum_<?php echo $forum[id]; ?>">
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo $forum[name]; ?></h3>
                ...
                <div style="line-height: 24px;">
                    ...
                    <?php }?>
                    <span class="label label-success">可用床位：<?php echo $forum[total_bed]; ?></span>
                    <span class="label label-warning">入住床位：<?php echo $forum[check_bed]; ?></span>
                    <span class="label label-default"><i class="fa fa-bar-chart"></i>入住率：<?php echo number_format($forum[check_bed]/$forum[total_bed]*100,2); ?>%</span>
                </div>
            </div>
                    ...
                    <div class="col-md-11 col-xs-10">
                        ...
                        <div class="col-md-1 col-xs-3 clearspace text-center">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <?php if($bed[stat]==1){?>
                                <a href="/work/order?id=<?php echo $bed[id]; ?>"><div class="bed <?php echo $bed[order_id]>0?'label-danger':'label-success'; ?>"><?php echo $bed[bed]; ?></div></a>
                                <?php } else { ?>
                                <div class="bed label-primary"><?php echo $bed[note]; ?></div>
                                <?php }?>
                                <?php }}?>
                            </div>
                            <?php } else { ?>
...
<!-- /.content-wrapper -->
<?php include template("html_footer_lte");?>